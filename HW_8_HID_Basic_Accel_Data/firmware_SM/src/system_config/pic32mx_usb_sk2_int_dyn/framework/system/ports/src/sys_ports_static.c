...
void SYS_PORTS_Initialize(void)
{
    ...
    ANSELBbits.ANSB13 = 0; //SM: Turn off analog funcitonality on pin B13
    PLIB_PORTS_DirectionOutputSet( PORTS_ID_0, PORT_CHANNEL_B,0x8E);//Pins B1(LED),B2(LED),B3(OLED POWER),B7 (LED) as digital outputs
    PLIB_PORTS_OpenDrainEnable(PORTS_ID_0, PORT_CHANNEL_B, 0);

    LATBbits.LATB3 = 1; //Set B2 high to power OLED
